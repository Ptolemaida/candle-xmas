...
> Άνοιγμα αυτής της σελίδας στο [https://ptolemaida.github.io/candle-xmas/](https://ptolemaida.github.io/candle-xmas/)
...
* αναζήτηση για **https://github.com/ptolemaida/candle-xmas** και εισαγωγή
...
* επικολλήστε **https://github.com/ptolemaida/candle-xmas** και κάντε κλικ στην εισαγωγή
